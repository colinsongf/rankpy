...
cdef INT_t argranksort_c(DOUBLE_t *ranking_scores, INT_t *ranks, INT_t n_documents, unsigned int *seed) nogil
cdef INT_t argranksort_queries_c(INT_t *query_indptr, INT_t n_queries, DOUBLE_t *ranking_scores, INT_t *ranks, unsigned int *seed) nogil

cdef INT_t ranksort_c(DOUBLE_t *ranking_scores, INT_t *ranking, INT_t n_documents, unsigned int *seed) nogil
cdef INT_t ranksort_queries_c(INT_t *query_indptr, INT_t n_queries, DOUBLE_t *ranking_scores, INT_t *ranking, unsigned int *seed) nogil

cdef INT_t ranksort_relevance_scores_c(DOUBLE_t *ranking_scores, INT_t *relevance_scores, INT_t n_documents, INT_t *out, unsigned int *seed) nogil
