...
def compute_delta_dcg(np.ndarray[DOUBLE_t, ndim=1] gain, np.ndarray[DOUBLE_t, ndim=1] discount, INT_t cutoff, INT_t i, INT_t offset,
                      np.ndarray[INT_t, ndim=1] document_ranks, np.ndarray[INT_t, ndim=1] relevance_scores, DOUBLE_t scale, np.ndarray[DOUBLE_t, ndim=1] out):
    cdef:
        INT_t    j
